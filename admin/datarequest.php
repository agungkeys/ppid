<script>
	page.pageDestination("DataRequest");
</script>
	...
	<div class="row">
		<div class="col-md-12">
            <section class="panel">
                ...
                <div id="gridrequest" class="panel-body">
                    <div class="table-responsive">
                        <table id="DataTableRequest" class="table table-bordered table-striped table-hover">
                            <!-- <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Kategori SKPD</th>
...
<script src="dist/data_request.js" type="text/javascript"></script>